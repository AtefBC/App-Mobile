...
class FormationArduino extends React.Component {
    render(){
        return(
            ...
            <SafeAreaView style ={{flex: 1}}>
                ...
                <View style={FormationReactStyles.photoReact}>
                    <Image style={FormationReactStyles.React_Photo} source={require('./arduino.png')}/>
                </View>
                ...
                <View style={FormationReactStyles.descFormateur}>
                    ...
                    <View style={{paddingLeft: 20,flex:3}}>
                        <Image style={FormationReactStyles.Formateur_Photo} source={require('./unnamed.png')}/>
                    </View>
    ...
    export default FormationArduino;